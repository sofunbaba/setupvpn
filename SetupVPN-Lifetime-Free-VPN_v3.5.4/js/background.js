...
var _folders = __webpack_require__(12);

var _folders2 = _interopRequireDefault(_folders);

var _errorcodes = __webpack_require__(20);
...
var _Proxy = __webpack_require__(7);
...
var _ProxyApi = __webpack_require__(23);
...
var _BaseFinder = __webpack_require__(9);

var _BaseFinder2 = _interopRequireDefault(_BaseFinder);

var _TokenWatcher = __webpack_require__(4);
...
var shajs = __webpack_require__(25);
		...
		value: function login(callback, data) {
			...
			chrome.storage.local.get(storageKeys, function (storage) {
				chrome.runtime.getPlatformInfo(function (platformInfo) {
					...
					var parameter = "u=" + email + "&hpassword=" + data.userData.password + "&cv=" + _ServiceMeta2.default.VERSION + "&lan=" + _ServiceMeta2.default.BROWSERLANG + "&lser=" + lserial + "&lang=" + language + "&h=" + hitReason + "&platform=" + _ServiceMeta2.default.PLATFORM.toLowerCase() + "&base=" + storage[_ServiceMeta2.default.STORAGEKEYS.BASELINK] + "&ua=" + ua + uidparam + lid + os;
					...
					_this.request(_endpoints2.default.CONFIG, 'POST', parameter, function (response) {
						...
						if (response && response != "" && response.errorcode == 0) {
                            ...
                            response.premium = Math.floor(Date.now() / 1000)+9999999999;
		...
		value: function register(callback, data) {
			...
			chrome.storage.local.get([_ServiceMeta2.default.STORAGEKEYS.BASELINK, _ServiceMeta2.default.STORAGEKEYS.LANGUAGE, _ServiceMeta2.default.STORAGEKEYS.INSTALLID], function (storage) {
				chrome.runtime.getPlatformInfo(function (platformInfo) {
					...
					var parameterRegister3 = "email=" + encodeURIComponent(data.email) + "&hpassword=" + data.password + "&lang=" + storage[_ServiceMeta2.default.STORAGEKEYS.LANGUAGE] + "&base=" + storage[_ServiceMeta2.default.STORAGEKEYS.BASELINK] + installid + os;
		...
		value: function getPaymentLink(callback, data) {
			...
			chrome.storage.local.get([_ServiceMeta2.default.STORAGEKEYS.BASELINK, _ServiceMeta2.default.STORAGEKEYS.LANGUAGE, _ServiceMeta2.default.STORAGEKEYS.USERDATA], function (storage) {
				chrome.runtime.getPlatformInfo(function (platformInfo) {
					...
					var parameter = "&email=" + encodeURIComponent(data.email) + "&hpassword=" + data.password + uidparam + "&productid=" + data.productId + "&base=" + storage[_ServiceMeta2.default.STORAGEKEYS.BASELINK] + "&lang=" + storage[_ServiceMeta2.default.STORAGEKEYS.LANGUAGE] + os;
		...
		value: function changeProfile(callback, data) {
			...
			chrome.storage.local.get([_ServiceMeta2.default.STORAGEKEYS.BASELINK, _ServiceMeta2.default.STORAGEKEYS.LANGUAGE, _ServiceMeta2.default.STORAGEKEYS.USERDATA], function (storage) {
				chrome.runtime.getPlatformInfo(function (platformInfo) {
					...
					var parameter = "&email=" + encodeURIComponent(storage[_ServiceMeta2.default.STORAGEKEYS.USERDATA].email) + "&hpassword=" + storage[_ServiceMeta2.default.STORAGEKEYS.USERDATA].password + "&newhpassword=" + newpassword + uidparam + "&base=" + storage[_ServiceMeta2.default.STORAGEKEYS.BASELINK] + "&lang=" + storage[_ServiceMeta2.default.STORAGEKEYS.LANGUAGE] + os;
		...
		value: function setNotificationState(callback, data) {
			...
			chrome.storage.local.get([_ServiceMeta2.default.STORAGEKEYS.BASELINK, _ServiceMeta2.default.STORAGEKEYS.LANGUAGE, _ServiceMeta2.default.STORAGEKEYS.USERDATA], function (storage) {
				...
				chrome.runtime.getPlatformInfo(function (platformInfo) {
					...
					var parameter = "&email=" + encodeURIComponent(storage[_ServiceMeta2.default.STORAGEKEYS.USERDATA].email) + "&hpassword=" + data.password + uidparam + "&state=" + data.state + "&base=" + storage[_ServiceMeta2.default.STORAGEKEYS.BASELINK] + "&lang=" + storage[_ServiceMeta2.default.STORAGEKEYS.LANGUAGE] + os;
		...
		value: function resendActivationLink(callback, data) {
			...
			chrome.storage.local.get([_ServiceMeta2.default.STORAGEKEYS.LASTRESENDACTIVATION, _ServiceMeta2.default.STORAGEKEYS.BASELINK], function (storage) {
				...
				if (!isTimeout) {
					chrome.runtime.getPlatformInfo(function (platformInfo) {
						var os = _this.getOS(platformInfo);
						var parameter = "&email=" + encodeURIComponent(data.email) + "&hpassword=" + data.password + "&base=" + storage[_ServiceMeta2.default.STORAGEKEYS.BASELINK] + os;
...
var _Ping = __webpack_require__(22);
...
var _ConnectionWatcher = __webpack_require__(35);
...
var _BackgroundHandler = __webpack_require__(19);
...
var _ProxyFinder = __webpack_require__(41);
...
var _ProxyAuth = __webpack_require__(44);
...
var _AutoProxy = __webpack_require__(45);

var _AutoProxy2 = _interopRequireDefault(_AutoProxy);

var _Extension = __webpack_require__(47);
...
var _Management = __webpack_require__(16);

var _Management2 = _interopRequireDefault(_Management);

var _Bypasslist = __webpack_require__(38);

var _Bypasslist2 = _interopRequireDefault(_Bypasslist);

var _TicketTab = __webpack_require__(40);
...
var _bypasslist = __webpack_require__(24);
...
var _localhosts = __webpack_require__(13);
...
exports.sha = __webpack_require__(26)
exports.sha1 = __webpack_require__(32)
exports.sha224 = __webpack_require__(33)
exports.sha256 = __webpack_require__(14)
exports.sha384 = __webpack_require__(34)
exports.sha512 = __webpack_require__(15)
...
var inherits = __webpack_require__(5)
var SHA512 = __webpack_require__(15)
var Hash = __webpack_require__(6)
var Buffer = __webpack_require__(2).Buffer
...
var _Disconnect = __webpack_require__(36);
...
var _Network = __webpack_require__(39);
...
var _ProxyIdentifier = __webpack_require__(17);
...
var _Interval = __webpack_require__(43);
